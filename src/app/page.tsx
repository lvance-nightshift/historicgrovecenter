        ...
        <section className="mx-auto max-w-6xl space-y-4 px-4 py-8 sm:px-6">
          {harvestUpcoming && (
            <FeaturedBanner
              ...
              blurb="An elegant black-tie dinner ($100/person) with the Historic Grove Theater's brand-new mural as its backdrop — mural preview, Grove Theater tours, live music & a gourmet dinner by Fire & Salt, benefiting the Grove Theater & local arts. 1940s/50s attire encouraged."
